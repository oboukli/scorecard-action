...
jobs:
  analyze:
    ...
    permissions:
      ...
      # Used to receive a badge and/or to query Scorecard REST API.
      # id-token: write
    ...
    steps:
      ...
      - name: Run analysis
        ...
        with:
          ...
          # (Optional) "write" PAT token. Uncomment the `repo_token`
          # line below:
          # - to enable the Branch-Protection check on a *public* repository,
          # - or to install Scorecard on a *private* repository
          # To create the PAT, follow the steps in
          # https://github.com/ossf/scorecard-action#authentication-with-pat-optional.
          # repo_token: ${{ secrets.SCORECARD_TOKEN }}

          # Publish the results for public repositories to enable scorecard badges.
          # For more details, see
          # https://github.com/ossf/scorecard-action#publishing-results.
          # For private repositories, `publish_results` will automatically be reset
          # to `false`, regardless of the value entered here.
          # publish_results: true

      # Upload the results as artifacts (optional).
      # Commenting out will disable uploads of run results in SARIF format to
      # the GitHub repository Actions tab.
      # - name: Upload artifact
      #   uses: actions/upload-artifact@0b7f8abb1508181956e8e162db84b466c27e18ce # tag: v3.1.2
      #   with:
      #     name: SARIF file
      #     path: openssf-scorecard.sarif
      #     retention-days: 5

      # Upload the results to GitHub.
      - name: Report analysis results to GitHub
        uses: github/codeql-action/upload-sarif@f31a31c052207cc13b328d6295c5b728bb49568c # tag: v2.3.5
        with:
